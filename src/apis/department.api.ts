...
export const getFields = (departmentId: string) =>
...
export const updateAdminDepartment = (id: string, body: { name: string; description: string; logo: string }) =>
...
export const deleteAdminDepartment = (id: string) =>
