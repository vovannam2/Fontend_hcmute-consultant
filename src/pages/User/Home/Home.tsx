...
export default function Home() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const params: any = { ...questionQueryConfig }
      if (searchValue.trim()) {
  ...
  return (
    <div className='min-h-screen bg-background selection:bg-blue-100 pt-16'>
      <div className='flex relative max-w-[1920px] mx-auto'>
        ...
        <main className='flex-1 lg:ml-[280px] lg:mr-[320px] relative z-10'>
          <div className='max-w-4xl mx-auto px-6 pt-3 pb-6 space-y-4'>
            ...
            <div className='bg-background rounded-xl border border-secondary shadow-sm overflow-hidden'>
              {/* Header */}
              <div className='px-6 py-4 border-b border-secondary bg-gradient-to-r from-primary/5 to-blue-50/30'>
                <div className='flex items-center justify-between mb-3'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      <h2 className='text-lg font-semibold text-foreground'>Câu hỏi gần đây</h2>
                ...
                <div className='relative'>
                  ...
                  <input
                    ...
                    className='w-full pl-10 pr-4 py-2.5 rounded-lg bg-white border-2 border-gray-200 focus:border-primary focus:ring-0 text-sm text-foreground placeholder:text-muted-foreground transition-all duration-200'
                  />
                </div>
              </div>
