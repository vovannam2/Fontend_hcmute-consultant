...
export default function Register() {
  ...
  const effectiveStatus = (status as RegisterStatusType) || registerStatus.create
    ...
    <div className='bg-primary-bg'>
      <div className='container '>
        <div className='flex flex-col items-center py-6'>
          ...
          <RegisterStatus status={effectiveStatus} />
          <div className='w-full lg:w-2/3 flex-shrink-0 px-4 py-2 shadow-md rounded'>
            {effectiveStatus === registerStatus.create && <RegisterForm />}
            {effectiveStatus === registerStatus.confirm && <ConfirmToken setIsConfirmSuccess={setIsConfirmSuccess} />}
            {effectiveStatus === registerStatus.success && (
