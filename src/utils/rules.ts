...
export const RegisterSchema = yup.object({
  ...
  gender: yup.string().oneOf(['NAM', 'NU']).required('Bạn phải chọn giới tính')
})
...
export const CreateGroupConversationSchema = yup.object({
  name: yup.string().required('Bạn phải nhập tên nhóm')
})
